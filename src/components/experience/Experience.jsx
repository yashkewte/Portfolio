        ...
        <div id='Experience' className='p-10 md:p-24'>
            ...
            <div className='flex flex-wrap items-center justify-around'>
                ...
                <div className='flex flex-wrap gap-5 mt-5 md:mt-20'>
                    <div className='group flex gap-10 w-70 md:w-80 bg-slate-950 bg-opacity-45 mt-4 rounded-lg p-4 items-center hover:scale-105 transition-all duration-300 hover:bg-opacity-60'>
                    ...
                    <div className='group flex gap-10 w-70 md:w-80 bg-slate-950 bg-opacity-45 mt-4 rounded-lg p-4 items-center hover:scale-105 transition-all duration-300 hover:bg-opacity-60 hover:shadow-lg hover:shadow-green-500/20'>
