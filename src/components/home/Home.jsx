  ...
  return (
    <div className='text-white flex w-full justify-between items-start p-8 md:p-15'>
      <div className='md:w-2/4 md:pt-10'>
        ...
        <a href="#Contact"><button className='mt-5 md:md-10 text-white py-2 px-3 text-sm md:text-lg bg-yellow-500 rounded-3xl md:py-2 md:px-4 hover:opacity-80 duration-300 hover:scale-105 font-semibold'>Contact Me</button></a>
      </div>
